...
def main(test=False):
    ...
    try:
        ...
        if (community_id):
            ...
            community_data = sds_client.SharedStreams.getLastValue(community_stream.TenantId, community_stream.NamespaceId, 
                community_stream.CommunityId, community_stream.Id, WaveData)
